...
public class GuardarCategoria extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet GuardarCategoria</title>");
            ...
            try {
                ...
                Logger.getLogger(GuardarCategoria.class.getName()).log(Level.SEVERE, null, msg);
            }

            out.println("<div align='center'>");
            out.println("<b>" + msg + "</b></br>");
            out.println("<a href='MostrarCategorias'>Lista de Categorias</a>");
            out.println("</div>");
